                ...
                switch (_a.label) {
                    case 0:
                        if (request.query.type === undefined)
                            return [2 /*return*/, response.status(400).send('invalid params: missing type')];
                        if (!request.file) {
                            return [2 /*return*/, response.status(400).send('No files were uploaded.')];
                        }
                        return [4 /*yield*/, this.uploadRepository.upload(request)];
                    case 1:
