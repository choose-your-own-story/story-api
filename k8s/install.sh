...
export DOCKER_IMAGE_VERSION_FIRST_ITEM=$DOCKER_METADATA_OUTPUT_JSON | jq '.tags[0]'
export DOCKER_IMAGE_VERSION=$(echo "$DOCKER_IMAGE_VERSION_FIRST_ITEM" | sed 's/\//\\\//g')

echo $DOCKER_METADATA_OUTPUT_JSON

echo "a"
echo $DOCKER_IMAGE_VERSION_FIRST_ITEM
